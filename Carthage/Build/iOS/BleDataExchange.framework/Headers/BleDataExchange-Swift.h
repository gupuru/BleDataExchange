...
SWIFT_CLASS("_TtC15BleDataExchange15BleDataExchange")
@interface BleDataExchange : NSObject <CBPeripheralManagerDelegate, CBCentralManagerDelegate, CBPeripheralDelegate>
@property (nonatomic, copy) NSString * _Nonnull serviceUUID;
@property (nonatomic, copy) NSString * _Nonnull readCharacteristicUUID;
@property (nonatomic, copy) NSString * _Nonnull writeCharacteristicUUID;
@property (nonatomic, copy) NSString * _Nonnull initData;
- (NSString * _Nonnull)initData SWIFT_METHOD_FAMILY(none);
@property (nonatomic, copy) NSString * _Nonnull localNameKey;
- (void)start;
- (void)stop;
